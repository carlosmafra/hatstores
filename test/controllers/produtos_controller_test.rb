...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { code: @produto.code, image: @produto.image, marca: @produto.marca, name: @produto.name, nparcela: @produto.nparcela, price: @produto.price, url: @produto.url, vparcela: @produto.vparcela }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { code: @produto.code, image: @produto.image, marca: @produto.marca, name: @produto.name, nparcela: @produto.nparcela, price: @produto.price, url: @produto.url, vparcela: @produto.vparcela }
    assert_redirected_to produto_path(assigns(:produto))
  end
